...
namespace SenseLib.Migrations
{
    ...
    [Migration("20250514082545_AddLoginAttemptsAndSystemConfig")]
    partial class AddLoginAttemptsAndSystemConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SenseLib.Models.CommentLike", b =>
                {
            ...
            modelBuilder.Entity("SenseLib.Models.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SenseLib.Models.Purchase", b =>
                {
            ...
            modelBuilder.Entity("SenseLib.Models.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ConfigID = 2,
                            ConfigKey = "LockoutTimeMinutes",
                            ConfigValue = "30",
                            Description = "Thời gian khóa tài khoản tạm thời (phút)"
                        },
                        new
                        {
                            ConfigID = 3,
                            ConfigKey = "HomePagePaidDocuments",
                            ConfigValue = "4",
                            Description = "Số lượng tài liệu có phí hiển thị trên trang chủ"
                        },
                        new
                        {
                            ConfigID = 4,
                            ConfigKey = "HomePageFreeDocuments",
                            ConfigValue = "4",
                            Description = "Số lượng tài liệu miễn phí hiển thị trên trang chủ"
                        });
                });
            ...
            modelBuilder.Entity("SenseLib.Models.Comment", b =>
                {
                    ...
                    b.HasOne("SenseLib.Models.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("SenseLib.Models.CommentLike", b =>
                {
                    b.HasOne("SenseLib.Models.Comment", "Comment")
